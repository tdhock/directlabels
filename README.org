![[https://directlabels.netlify.app][./logos/directlabels logo (orange).png]]
...
Please check [[https://directlabels.netlify.app/docs/index.html][the documentation page]] (with links to examples for specific methods) and [[https://directlabels.netlify.app/examples.html][the page with several advanced examples]].
...
The [[https://directlabels.netlify.app/docs/index.html][directlabels documentation examples site]] can be generated in the =site= directory by using:
